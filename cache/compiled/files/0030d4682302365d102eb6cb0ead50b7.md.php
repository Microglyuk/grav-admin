...
return [
    ...
    'filename' => 'C:/wamp64/www/git/grav-admin/user/pages/02.blog/random-thoughts/item.md',
    'modified' => 1649236780,
    'data' => [
        'header' => [
...
taxonomy:
    category: blog
    tag: [journal]',
        'markdown' => 'Mauris felis diam, pellentesque vel lacinia ac, dictum a nunc. Mauris mattis nunc sed mi sagittis et facilisis tortor volutpat. Etiam tincidunt urna mattis erat placerat placerat ac eu tellus.
